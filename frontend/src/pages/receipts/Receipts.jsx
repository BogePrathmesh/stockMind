    ...
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage incoming goods</p>
        </div>
        <button
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {loading ? (
              ...
              <tr><td colSpan="6" className="px-6 py-4 text-center text-gray-500">No receipts found</td></tr>
            ) : (
              receipts.map((receipt) => (
                <tr key={receipt.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">{receipt.receiptId}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receipt.supplier}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{receipt.warehouse?.name}</td>
